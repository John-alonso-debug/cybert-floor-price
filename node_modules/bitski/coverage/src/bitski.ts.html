...
export { Store, <span class="fstat-no" title="function not covered" >LocalStorageStore </span>};
&nbsp;
// Sign-in Options
export { SignInOptions, LOGIN_HINT_SIGNUP };
&nbsp;
// Networks
export { Network, Mainnet, Rinkeby, <span class="fstat-no" title="function not covered" >Kovan </span>};
&nbsp;
// Connect Button
export { <span class="fstat-no" title="function not covered" >ConnectButtonSize,</span> ConnectButtonOptions };
&nbsp;
// Errors
export { AuthenticationError, <span class="fstat-no" title="function not covered" >AuthenticationErrorCode </span>} from './errors/authentication-error';
export { <span class="fstat-no" title="function not covered" >ParseError,</span> <span class="fstat-no" title="function not covered" >ParseErrorCode </span>} from './errors/parse-error';
export { <span class="fstat-no" title="function not covered" >SignerError,</span> <span class="fstat-no" title="function not covered" >SignerErrorCode </span>} from './errors/signer-error';
&nbsp;
...
&nbsp;
  ...
  public signOut(): Promise&lt;void&gt; {
    this.engines.forEach(<span class="fstat-no" title="function not covered" >(e</span>ngine) =&gt; <span class="cstat-no" title="statement not covered" >engine.emit('signOut'))</span>;
